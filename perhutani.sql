...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2017 at 11:30 AM
...
INSERT INTO `admin` (`id_admin`, `username`, `nama_lengkap`, `password`, `role`) VALUES
(1, 'admin', 'Yohana Agustina Ginting', 'c3284d0f94606de1fd2af172aba15bf3', 'admin'),
(2, 'operator', 'operator', 'a2ac1e2a67f66b89e4b181d542c8fcca', 'operator');
...
(2, 'TUB', 'Tinta Roneo', 'Barang-Barang Keperluan Kantor', 10, '200.000,00', '2.000.000,', '2017-07-08'),
...
CREATE TABLE `operator` (
  `id_operator` int(5) UNSIGNED NOT NULL,
  `nama_lengkap` varchar(30) NOT NULL,
...
(101, 'Handika Pratama', '085740182195', 'operator');
...
--
ALTER TABLE `barang_masuk`
  MODIFY `id_masuk` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `operator`
--
ALTER TABLE `operator`
  MODIFY `id_operator` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
--
