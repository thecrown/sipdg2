              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <div class="modal fade" id="editsk<?=$key->id_masuk;?>" role="dialog">
                  <div class="modal-dialog">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal" method="post" action="<?=base_url('UpdateCatatBarangMasuk/').$key->id_masuk;?>">
                          <div class="form-group">
                            ...
                            <input required="true" type="date" class="form-control" value="<?=$key->tanggal;?>" id="recipient-name">
                          </div>
                          <div class="form-group">
                            <label for="inputPassword3" class="form-control-label">Nama Barang<span class="text-danger">*</span></label>
                            <input required="true" type="text" class="form-control" value="<?=$key->nama_barang;?>" id="recipient-name">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" required="true" class="form-control" value="<?=$key->jumlah;?>" id="input1">
                          </div>
                          <div class="form-group">
                    ...
                    <i class="fa">Rp</i></div><input type="text" required class="form-control" value="<?=$key->harga;?>" id="input2">
                          </div></div>
                          <div class="form-group">
                    ...
                    <i class="fa">Rp</i></div><input type="text" required class="form-control" id="output" value="<?php echo $totalharga; ?>">
                          </div></div>
