        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <span data-toggle="tooltip" title="Tambah Operator"><a role="button" href="#addoperator" class="btn btn-success" data-toggle="modal"><i class="fa fa-pencil-square-o bigicon" >&nbsp;&nbsp;Tambah Operator</i></a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="modal fade" id="addoperator" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body col-xs-12">
                        <form class="form-horizontal" method="post" action="<?=base_url('AddOperator');?>">
